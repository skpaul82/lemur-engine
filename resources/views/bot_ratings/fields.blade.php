...
@if( !empty($botRating) && !empty($botRating->slug) && strpos('slug', 'slug')!==false)
    ...
    <div class="form-group col-sm-6" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255, 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\botRating::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
...
@elseif( !empty($botRating) && !empty($botRating->slug) && strpos('slug', 'url')!==false)
    ...
    <div class="form-group col-sm-6" data-test="slug_div">
        {!! Form::label('slug', 'Slug:', ['data-test'=>"slug_label"]) !!}
        <div class="input-group">
            {!! Form::text('slug', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255, App\Models\botRating::getFormValidation('slug'), 'id'=>"slug_field", 'data-test'=>"slug_field"]) !!}
            <div class="input-group-btn">
