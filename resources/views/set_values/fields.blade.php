...
@if( !empty($setValue) && !empty($setValue->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\SetValue::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
...
@if( !empty($setValue) && !empty($setValue->set_id))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="set_id_div">
        ...
        <div class="input-group">
            {!! Form::hidden('set_id', $setValue->set_id, ['id'=>"set_id_hidden_field", 'data-test'=>"set_id_hidden_field", App\Models\SetValue::getFormValidation('set_id')]) !!}
            {!! Form::text('set', $setValue->set->name, ['readonly'=>'readonly','class' => 'form-control', 'id'=>"set_id_field", 'data-test'=>"set_id_field", App\Models\SetValue::getFormValidation('set_id')]) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="value_div">
    ...
    {!! Form::text('value', null, ['class' => 'form-control', App\Models\SetValue::getFormValidation('value'),'id'=>"value_field", 'data-test'=>"value_field"] ) !!}
</div>
