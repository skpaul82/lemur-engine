<div class='btn-group'  data-test="{$htmlTag}-datatable-actions">
    <a href="{{ route('bots.show', $id) }}" class='btn btn-info btn-xs show-button' data-test="show-button">
        <i class="glyphicon glyphicon-eye-open"></i>
    </a>
    <a href="{{ route('bots.edit', $id) }}"  class='btn btn-success btn-xs edit-button' data-test="edit-button">
