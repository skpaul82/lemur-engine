...
@if( !empty($language) && !empty($language->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\Language::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="name_div">
    ...
    {!! Form::text('name', null, ['class' => 'form-control', App\Models\Language::getFormValidation('name'),'id'=>"name_field", 'data-test'=>"name_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="description_div">
    ...
    {!! Form::text('description', null, ['class' => 'form-control', App\Models\Language::getFormValidation('description'),'id'=>"description_field", 'data-test'=>"description_field"] ) !!}
</div>
