...
@if( !empty($conversation) && !empty($conversation->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        <div class="input-group">
            {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\Conversation::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="bot_slug_div">
    ...
    <div class="input-group">
        {!! Form::text('', $conversation->bot->name.' ('.$conversation->bot->slug.')', ['disabled'=>'disabled', 'readonly'=>'readonly','class' => 'form-control', 'id'=>"bot_slug_field", 'data-test'=>"bot_slug_field", App\Models\SetValue::getFormValidation('bot_id')]) !!}
        <div class="input-group-btn">
...
<!-- Client Id Field -->
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="client_slug_div">
        ...
        <div class="input-group">
            {!! Form::text('client_slug', $conversation->client->slug, ['disabled'=>'disabled','readonly'=>'readonly', 'class' => 'form-control', 'id'=>"client_slug_field", 'data-test'=>"client_slug_field", App\Models\Conversation::getFormValidation('client_id')]) !!}
            <div class="input-group-btn">
