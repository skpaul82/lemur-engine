                ...
                <div class="box box-warning direct-chat direct-chat-warning">
                    ...
                    <div class="box-body">
                        ...
                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                            <div class="tab-pane fade active in" id="pills-chat" role="tabpanel" aria-labelledby="nav-home-tab">
                                @include('conversations.show_by_bot_conversation_list')
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
        ...
        <div class="col-md-8">
            ...
            <div class="box box-warning direct-chat direct-chat-warning">
                <div class="box-header with-border">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item active">
                            <a class="nav-link small" id="pills-chat-tab" data-toggle="pill" href="#pills-chat" role="tab" aria-controls="pills-home" aria-selected="true">Chat</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link small" id="pills-conversation-properties-tab" data-toggle="pill" href="#pills-conversation-properties" role="tab" aria-controls="pills-contact" aria-selected="false">Conversation Properties</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="box-body">
                    ...
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade active in" id="pills-chat" role="tabpanel" aria-labelledby="pills-chat">
                            @include('turns.show_by_bot_by_conversation')
                        </div>
