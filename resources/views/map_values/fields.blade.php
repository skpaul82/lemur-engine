...
@if( !empty($mapValue) && !empty($mapValue->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\mapValue::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
...
@if( !empty($mapValue) && !empty($mapValue->map_id))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="map_id_div">
        ...
        <div class="input-group">
            {!! Form::hidden('map_id', $mapValue->map_id, ['id'=>"map_id_hidden_field", 'data-test'=>"map_id_hidden_field", App\Models\MapValue::getFormValidation('map_id')]) !!}
            {!! Form::text('map', $mapValue->map->name, ['readonly'=>'readonly','class' => 'form-control', 'id'=>"map_id_field", 'data-test'=>"map_id_field", App\Models\MapValue::getFormValidation('map_id')]) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="word_div">
    ...
    {!! Form::text('word', null, ['class' => 'form-control', App\Models\mapValue::getFormValidation('word'),'id'=>"word_field", 'data-test'=>"word_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="value_div">
    ...
    {!! Form::text('value', null, ['class' => 'form-control', App\Models\mapValue::getFormValidation('value'),'id'=>"value_field", 'data-test'=>"value_field"] ) !!}
</div>
