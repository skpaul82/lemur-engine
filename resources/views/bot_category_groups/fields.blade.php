...
@if(!empty($botCategoryGroup) && !empty($botCategoryGroup->bot))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="category_group_id_div">
        ...
        <div class="input-group">
            {!! Form::text('bot_id', $botCategoryGroup->bot->name, ['readonly'=>'readonly','class' => 'form-control', 'id'=>"bot_id_field", 'data-test'=>"bot_id_field", App\Models\SetValue::getFormValidation('bot_id')]) !!}
...
@else
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="bot_id_div">
        {!! Form::label('bot_id', 'Bot:', ['data-test'=>"bot_id_label"]) !!}
        {!! Form::select('bot_id', $botList, (!empty($botCategoryGroup)?$botCategoryGroup->bot->slug:(!empty($botCategoryGroup)?$botCategoryGroup->bot->slug:"")), [  'placeholder'=>'Please Select', 'class' => 'form-control select2 generic', App\Models\BotCategoryGroup::getFormValidation('bot_id'), 'data-test'=>"$htmlTag-bot_id-select", 'id'=>"$htmlTag-bot_id-select"]) !!}
    </div>
...
@if(!empty($botCategoryGroup) && !empty($botCategoryGroup->categoryGroup))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="category_group_id_div">
        ...
        <div class="input-group">
            {!! Form::text('category_group_id', $botCategoryGroup->categoryGroup->name, ['readonly'=>'readonly','class' => 'form-control', 'id'=>"category_group_id_field", 'data-test'=>"category_group_id_field", App\Models\SetValue::getFormValidation('category_group_id')]) !!}
            <div class="input-group-btn">
