...
@if( !empty($botKey) && !empty($botKey->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\BotKey::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
    <div class="clearfix"></div>
...
@elseif(!empty($botKey) && !empty($botKey->bot))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="bot_slug_div">
        ...
        <div class="input-group">
            {!! Form::text('', $botKey->bot->name.' ('.$botKey->bot->slug.')', ['disabled'=>'disabled', 'readonly'=>'readonly','class' => 'form-control', 'id'=>"bot_slug_field", 'data-test'=>"bot_slug_field", App\Models\BotKey::getFormValidation('bot_id')]) !!}
...
@else
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="bot_id_div">
        ...
        {!! Form::select('bot_id', $botList, (!empty($botKey)?$botKey->bot->slug:(!empty($botKey)?$botKey->bot->slug:"")), [  'placeholder'=>'Please Select', 'class' => 'form-control select2 generic', App\Models\BotKey::getFormValidation('bot_id'), 'data-test'=>"$htmlTag-bot_id-select", 'id'=>"$htmlTag-bot_id-select"]) !!}
    </div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="name_div">
    ...
    {!! Form::text('name', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255, App\Models\BotKey::getFormValidation('name'),'id'=>"name_field", 'data-test'=>"name_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="description_div">
    ...
    {!! Form::textarea('description', null, ['rows'=>3, 'class' => 'form-control','maxlength' => 100,'maxlength' => 100, App\Models\BotKey::getFormValidation('description'),'id'=>"description_field", 'data-test'=>"description_field"] ) !!}
</div>
...
<div class="form-group col-sm-12 col-md-6" data-test="email_div">
    ...
    <div class="input-group">
        {!! Form::text('value', null, ['readonly'=>'readonly','class' => 'form-control','maxlength' => 255,'maxlength' => 255, App\Models\BotKey::getFormValidation('value'),'id'=>"value_field", 'data-test'=>"value_field"] ) !!}
        <div class="input-group-btn">
