...
@if( !empty($emptyResponse) && !empty($emptyResponse->slug) )
    ...
    <div class="form-group col-sm-6" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\EmptyResponse::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
...
@if( !empty($emptyResponse) && !empty($emptyResponse->turn_id) && strpos('turn_id', '_id')!==false)
    ...
    <div class="form-group col-sm-3" data-test="conversation_log_id_div">
        ...
        <div class="input-group">
            {!! Form::number('turn_id', null, ['class' => 'form-control', 'id'=>"conversation_log_id_field", 'data-test'=>"conversation_log_id_field", App\Models\EmptyResponse::getFormValidation('turn_id')]) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="raw_input_div">
    ...
    {!! Form::textarea('raw_input', null, ['rows' => 2, 'class' => 'form-control', 'id'=>"raw_input_field", 'data-test'=>"raw_input_field", App\Models\EmptyResponse::getFormValidation('raw_input')] ) !!}
</div>
<div class="clearfix"></div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="raw_that_div">
    ...
    {!! Form::textarea('raw_that', null, ['rows' => 2, 'class' => 'form-control', 'id'=>"raw_that_field", 'data-test'=>"raw_that_field", App\Models\EmptyResponse::getFormValidation('raw_that')] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="raw_topic_div">
    ...
    {!! Form::text('raw_topic', null, ['class' => 'form-control', App\Models\EmptyResponse::getFormValidation('raw_topic'),'id'=>"raw_topic_field", 'data-test'=>"raw_topic_field"] ) !!}
</div>
<div class="clearfix"></div>
