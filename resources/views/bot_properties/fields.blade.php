...
@if( !empty($botProperty) && !empty($botProperty->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\BotProperty::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
    <div class="clearfix"></div>
...
@elseif(!empty($botProperty) && !empty($botProperty->bot))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="bot_slug_div">
        ...
        <div class="input-group">
            {!! Form::text('bot_slug', $botProperty->bot->name.' ('.$botProperty->bot->slug.')', ['disabled'=>'disabled','readonly'=>'readonly','class' => 'form-control', 'id'=>"bot_slug_field", 'data-test'=>"bot_slug_field", App\Models\SetValue::getFormValidation('bot_id')]) !!}
...
@else
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="bot_id_div">
        ...
        {!! Form::select('bot_id', $botList, (!empty($botProperty)?$botProperty->bot->slug:(!empty($botProperty)?$botProperty->bot->slug:"")), [  'placeholder'=>'Please Select', 'class' => 'form-control select2 generic', App\Models\BotProperty::getFormValidation('bot_id'), 'data-test'=>"$htmlTag-bot_id-select", 'id'=>"$htmlTag-bot_id-select"]) !!}
    </div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="name_div">
    ...
    {!! Form::text('name', null, ['readonly'=>$readonly, 'class' => 'form-control', App\Models\BotProperty::getFormValidation('name'),'id'=>"name_field", 'data-test'=>"name_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="value_div">
    ...
    {!! Form::text('value', null, ['class' => 'form-control', App\Models\BotProperty::getFormValidation('value'),'id'=>"value_field", 'data-test'=>"value_field"] ) !!}
</div>
