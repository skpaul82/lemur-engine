...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="conversation_id_div">
    ...
    <div class="input-group">
        {!! Form::text('', $conversationProperty->conversation->slug, ['readonly'=>'readonly', 'class' => 'form-control', 'id'=>"conversation_id_field", 'data-test'=>"conversation_id_field", App\Models\Turn::getFormValidation('conversation_id')]) !!}
...
<div class="form-group col-sm-6" data-test="name_div">
    ...
    {!! Form::text('name', null, ['class' => 'form-control', App\Models\ConversationProperty::getFormValidation('name'),'id'=>"name_field", 'data-test'=>"name_field"] ) !!}
</div>
...
<div class="form-group col-sm-6" data-test="value_div">
    ...
    {!! Form::text('value', null, ['class' => 'form-control', App\Models\ConversationProperty::getFormValidation('value'),'id'=>"value_field", 'data-test'=>"value_field"] ) !!}
</div>
