...
@if( !empty($wordTransformation) && !empty($wordTransformation->slug))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\WordTransformation::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
    </div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="language_id_div">
    ...
    {!! Form::select('language_id', $languageList, (!empty($wordTransformation)?$wordTransformation->language->slug:(!empty($wordTransformation)?$wordTransformation->language->slug:"")), [ App\Models\WordTransformation::getFormValidation('language_id'), 'placeholder'=>'Please Select', 'class' => 'form-control select2 generic', 'data-test'=>"$htmlTag-language_id-select", 'id'=>"$htmlTag-language_id-select"]) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="first_person_form_div">
    ...
    {!! Form::text('first_person_form', null, ['class' => 'form-control', App\Models\WordTransformation::getFormValidation('first_person_form'),'id'=>"first_person_form_field", 'data-test'=>"first_person_form_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="second_person_form_div">
    ...
    {!! Form::text('second_person_form', null, ['class' => 'form-control', App\Models\WordTransformation::getFormValidation('second_person_form'),'id'=>"second_person_form_field", 'data-test'=>"second_person_form_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="third_person_form_div">
    ...
    {!! Form::text('third_person_form', null, ['class' => 'form-control', App\Models\WordTransformation::getFormValidation('third_person_form'),'id'=>"third_person_form_field", 'data-test'=>"third_person_form_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="third_person_form_female_div">
    ...
    {!! Form::text('third_person_form_female', null, ['class' => 'form-control', App\Models\WordTransformation::getFormValidation('third_person_form_female'),'id'=>"third_person_form_female_field", 'data-test'=>"third_person_form_female_field"] ) !!}
</div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="third_person_form_male_div">
    ...
    {!! Form::text('third_person_form_male', null, ['class' => 'form-control', App\Models\WordTransformation::getFormValidation('third_person_form_male'),'id'=>"third_person_form_male_field", 'data-test'=>"third_person_form_male_field"] ) !!}
</div>
