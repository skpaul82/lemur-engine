...
@if(!empty($botWordSpellingGroup) && !empty($botWordSpellingGroup->bot))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="word_spelling_group_id_div">
        ...
        <div class="input-group">
            {!! Form::text('bot_id', $botWordSpellingGroup->bot->name, ['readonly'=>'readonly','class' => 'form-control', 'id'=>"bot_id_field", 'data-test'=>"bot_id_field", App\Models\SetValue::getFormValidation('bot_id')]) !!}
...
@if(!empty($botWordSpellingGroup) && !empty($botWordSpellingGroup->wordSpellingGroup))
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="word_spelling_group_id_div">
        ...
        <div class="input-group">
            {!! Form::text('word_spelling_group_id', $botWordSpellingGroup->wordSpellingGroup->name, ['readonly'=>'readonly','class' => 'form-control', 'id'=>"word_spelling_group_id_field", 'data-test'=>"word_spelling_group_id_field", App\Models\SetValue::getFormValidation('word_spelling_group_id')]) !!}
            <div class="input-group-btn">
...
@else
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12 select2" data-test="word_spelling_group_id_div">
        {!! Form::label('word_spelling_group_id', 'Word Spelling Group:', ['data-test'=>"word_spelling_group_id_label"]) !!}
        {!! Form::select('word_spelling_group_id', $wordSpellingGroupList, (!empty($botWordSpellingGroup)?$botWordSpellingGroup->wordSpellingGroup->slug:(!empty($botWordSpellingGroup)?$botWordSpellingGroup->wordSpellingGroup->slug:"")), [  App\Models\WordSpelling::getFormValidation('word_spelling_group_id'), 'placeholder'=>'Please Select', 'class' => 'form-control select2 generic', 'data-test'=>"$htmlTag-word_spelling_group_id_select", 'id'=>"$htmlTag-word_spelling_group_id_select-select"]) !!}
    </div>
