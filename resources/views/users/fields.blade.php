...
<div class="form-group col-sm-12 col-md-6 col-lg-6" data-test="name_div">
    ...
    {!! Form::text('name', null, ['class' => 'form-control', App\Models\User::getFormValidation('name'),'id'=>"name_field", 'data-test'=>"name_field"] ) !!}
</div>
...
<div class="form-group col-sm-12 col-md-6 col-lg-6" data-test="email_div">
    ...
    {!! Form::email('email', null, ['class' => 'form-control', 'id'=>"email_field", 'data-test'=>"email_field", App\Models\User::getFormValidation('email')]) !!}
</div>
...
<div class="form-group col-sm-12 col-md-6 col-lg-6 select2" data-test="user_role_div">
    ...
    {!! Form::select('user_role', ['author'=>'Author', 'admin'=>'Admin'], (!empty($user) && $user->hasRole('admin')?"admin":"author"), [  'placeholder'=>'Please Select', 'class' => 'form-control select2 generic', App\Models\Bot::getFormValidation('language_id'), 'data-test'=>"$htmlTag-language_id-select", 'id'=>"$htmlTag-language_id-select"]) !!}
</div>
