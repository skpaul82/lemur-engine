               ...
               <div class="row">
                   <div class="col-md-12">
                       ...
                       <div class="form-group col-sm-12 col-md-3" data-test="name_div">
                           ...
                           {!! Form::text('name', $user->name, ['class' => 'form-control', App\Models\User::getFormValidation('name'),'id'=>"name_field", 'data-test'=>"name_field"] ) !!}
                       </div>
                       ...
                       <div class="form-group col-sm-12 col-md-3" data-test="email_div">
                           ...
                           {!! Form::email('email', $user->email, ['class' => 'form-control', 'id'=>"email_field", 'data-test'=>"email_field", App\Models\User::getFormValidation('email')]) !!}
                       </div>
