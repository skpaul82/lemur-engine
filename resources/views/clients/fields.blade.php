...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="bot_slug_div">
    ...
    <div class="input-group">
        {!! Form::text('', $client->bot->name.' ('.$client->bot->slug.')', ['disabled'=>'disabled', 'readonly'=>'readonly','class' => 'form-control', 'id'=>"bot_slug_field", 'data-test'=>"bot_slug_field", App\Models\SetValue::getFormValidation('bot_id')]) !!}
        <div class="input-group-btn">
