...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="pattern_div">
    ...
    {!! Form::text('pattern', $turn->input, ['class' => 'form-control', App\Models\Category::getFormValidation('pattern'),'id'=>"pattern_field", 'data-test'=>"pattern_field"] ) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="that_div">
    ...
    @if(!empty($previousTurn))
        <div class="input-group">
            {!! Form::text('that', (!empty($previousTurn)?$previousTurn->output:''), ['class' => 'form-control', App\Models\Category::getFormValidation('that'),'id'=>"that_field", 'data-test'=>"that_field"] ) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="template_div">
    ...
    {!! Form::textarea('template', $turn->output, ['rows' => 10, 'class' => 'form-control', 'id'=>"template_field", 'data-test'=>"template_field", App\Models\Category::getFormValidation('template')] ) !!}
