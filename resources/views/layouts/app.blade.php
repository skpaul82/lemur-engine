    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            ...
            <small class="copyright">
                portal: {!! config('lemur_version.portal.id') !!} | bot: {!! config('lemur_version.bot.id') !!} |
                Designed with <i class="fa fa-heart"></i> by <a href="https://theramenrobotdiscocode.com/" target="_blank">The Ramen Robot Disco Code</a> and <i class="fa fa-github-alt"></i> <a href="https://github.com/theramenrobotdiscocode/lemur-engine">Friends</a>
