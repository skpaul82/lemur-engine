<li class="{{ Request::is('home*') ? 'active' : '' }} side-bar-top-level-menu">
    <a href="{!!  url('/home')  !!}" data-test="sidebar-link-home"><i class="fa fa-home !!}"></i><span>Home</span></a>
</li>
...
<li class="{{ Request::is('docs*') ? 'active' : '' }}">
    <a href="https://docs.lemurengine.com" data-test="sidebar-link-bots"><i class="fa fa-book"></i><span>Documentation</span></a>
</li>
