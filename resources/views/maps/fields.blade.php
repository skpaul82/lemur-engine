...
@if( !empty($map) && !empty($map->slug) )
    ...
    <div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="slug_div">
        ...
        {!! Form::text('slug', null, ['class' => 'form-control', 'id'=>"slug_field", 'readonly'=>'readonly', App\Models\map::getFormValidation('slug'), 'data-test'=>"slug_field"]) !!}
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="name_div">
    ...
    {!! Form::text('name', null, ['class' => 'form-control', App\Models\map::getFormValidation('name'),'id'=>"name_field", 'data-test'=>"name_field"] ) !!}
</div>
<div class="clearfix"></div>
...
<div class="form-group col-lg-6 col-md-6 col-sm-12" data-test="description_div">
    ...
    {!! Form::textarea('description', null, ['rows' => 2, 'class' => 'form-control', 'id'=>"description_field", 'data-test'=>"description_field", App\Models\Map::getFormValidation('description')] ) !!}
</div>
