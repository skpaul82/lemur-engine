...
class ConversationPolicyAuthorTest extends TestCase
{
    private $user;
    private $policy;
    ...
    public function getModelItem($user, $isPublic = false)
    {
        ...
        return factory(Conversation::class)->create(['bot_id'=>$bot->id, 'client_id'=>$client->id]);
    }
     ...
     */
    public function testCanViewAsAuthorAdminPublicItem()
    {
