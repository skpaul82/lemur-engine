...
use App\Traits\ConversationHelper;
...
class Conversation extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\Wildcard::class, 'conversation_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Turn::class, 'conversation_id')->human();
    }
    ...
    public function openSraiTags()
    {
        ...
        return $this->HasMany(\App\Models\Turn::class, 'conversation_id')->openRecursiveTags();
    }
    ...
    {
        return $this->hasMany(\App\Models\BotRating::class, 'conversation_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\ConversationProperty::class, 'conversation_id');
    }
