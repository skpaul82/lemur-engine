...
class WordSpellingGroup extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\BotWordSpellingGroup::class, 'word_spelling_group_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\WordSpelling::class, 'word_spelling_group_id');
    }
